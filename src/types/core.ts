...
export type GatewayErrorCode =
  ...
  // Spend limits (Phase 43+): a billed proxy call exceeded the daily total or
  // per-transaction cap (wallet-level or api-key-level; same wire shape). 429.
  // Source of truth = gateway error-catalog.ts. Surfaced distinctly via
  // SpendLimitError. Added additively.
